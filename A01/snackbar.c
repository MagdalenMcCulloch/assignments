...
//defining snack 1
  ...
  snack1.snackName[7] = '\0';
  // use strcpy(snack1.name, "popcorn")
...
//defining snack 3
  ...
  scanf(" %lf",&userMoneyAmount); // theres an error with printing here but idk how  
  for(int i = 0; i <3; i++){
  ...
  else if(snackArr[userSnackChoice].cost <= userMoneyAmount){
